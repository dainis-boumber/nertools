# -*- coding: utf-8 -*-
#
# nertools documentation build configuration file, created by
# sphinx-quickstart.
#
...
latex_documents = [
    ('index',
     'nertools.tex',
     u'nertools Documentation',
     u"Dainis Boumber", 'manual'),
]
...
man_pages = [
    ('index', 'nertools', u'nertools Documentation',
     [u"Dainis Boumber"], 1)
]
